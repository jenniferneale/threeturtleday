            ...
            {this.props &&  this.props.posts && this.props.posts.map(bp =>             
                ...
                { bp.teaserText? 
                    <div className="container col-xs-12">
                        {bp.cardImage && <div className="col-xs-4 pull-left pic" style={{background:`url(${bp.cardImage}) no-repeat scroll center center / cover transparent`}}>
                        </div>}
                        <div className={bp.cardImage? "col-xs-8 pull-left" : "col-xs-12"}>
                            <h3>{bp.title}</h3>
